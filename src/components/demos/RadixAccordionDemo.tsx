...
interface AccordionItemProps
  extends React.ComponentPropsWithRef<typeof Accordion.Item> {
...
interface TriggerProps
  extends React.ComponentPropsWithRef<typeof Accordion.Trigger> {
  children: React.ReactNode;
  className?: string;
}
...
interface ContentProps
  extends React.ComponentPropsWithRef<typeof Accordion.Content> {
  children: React.ReactNode;
  className?: string;
}
